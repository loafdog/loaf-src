All examples and code is from here:
...
=============================================================================
Below is cut/paste from webpage in case link disappears and so I can
reference explanations whenever I need.
=============================================================================
...
tweet this
Next: Option and null in dynamic languages

A quarterly publication from Hacker School
